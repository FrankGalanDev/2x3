...
<div> 
            ...
            <div class="row">
              <div class="col-md-3 col-sm-6">
                <div class="statistic-block block">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    ...
                    <div class="number dashtext-1">{{$exportaciones}}</div>
                  </div>
              ...
              <div class="col-md-3 col-sm-6">
                <div class="statistic-block block">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-contract"></i></div><strong>Sitios</strong>
                    </div>
                    <div class="number dashtext-2">{{$sitios}}</div>
                  </div>
                  <div class="progress progress-template">
              ...
              <div class="col-md-3 col-sm-6">
                <div class="statistic-block block">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-paper-and-pencil"></i></div><strong>Importaciones</strong>
                    </div>
                    <div class="number dashtext-3">{{$importaciones}}</div>
                  </div>
                  <div class="progress progress-template">
              ...
              <div class="col-md-3 col-sm-6">
                <div class="statistic-block block">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-writing-whiteboard"></i></div><strong>Proovedores</strong>
                    </div>
                    <div class="number dashtext-4">{{ $proveedores }}</div>
                  </div>
                  <div class="progress progress-template">
            ...
            <div class="row">
              <div class="col-lg-4">
                <div class="bar-chart block no-margin-bottom">
                  <canvas id="barChart1" height="280" width="600"></canvas>
                </div>
                <div class="bar-chart block">
                  <canvas id="barChartExample2">ojo</canvas>
                </div>
              </div>
              <div class="col-lg-8">
  ...
  <!------------FINAL SECCION GRAFICOS----------------->     
  
  <!------------INICIO SECCION VISITAS-----------------> 
        <section class="no-padding-bottom">
          <div class="container-fluid">
            <div class="row">
              <div class="col-lg-6">
                <div class="stats-2-block block d-flex">
                  <div class="stats-2 d-flex">
                    ...
                    <div class="stats-2-content">
                      ...
                      <div class="progress progress-template progress-small">
                        <div role="progressbar" style="width: 60%;" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" class="progress-bar progress-bar-template progress-bar-small dashbg-2"> 
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="stats-2 d-flex">
                    ...
                    <div class="stats-2-content">
                      ...
                      <div class="progress progress-template progress-small">
                        <div role="progressbar" style="width: 35%;" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" class="progress-bar progress-bar-template progress-bar-small dashbg-3"> 
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="stats-3-block block d-flex">
                  <div class="stats-3">
                    ...
                    <div class="progress progress-template progress-small">
                      <div role="progressbar" style="width: 35%;" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" class="progress-bar progress-bar-template progress-bar-small dashbg-1"> 
                      </div>
                    </div>
                  </div>
                  <div class="stats-3 d-flex justify-content-between text-center">
                    <div class="item">
                      <strong class="d-block strong-sm">
                        4.124
                      </strong>
                      <span class="d-block span-sm">
                        Threats
                      </span>
                      <div class="line"> 
                      </div>
  ...
  <!------------FINAL SECCION VISITAS----------------------> 
  <!-----------INICIO SECC ANLS X CLIENTES-----------------> 
  <!----------- AREA DE CLIENTES COMENTADA-------------      
        <section class="no-padding-bottom">
          <div class="container-fluid">
            <div class="row">
              <div class="col-lg-4">
            ...
            <div class="public-user-block block">
              <div class="row d-flex align-items-center">                   
                ...
                <div class="col-lg-4">
                  <div class="details d-flex">
                    <div class="item"><i class="icon-info"></i>
                      <strong>
                        60
                      </strong>
                    </div>
                    <div class="item"><i class="fa fa-gg"></i>
                      <strong>
                        70
                      </strong>
                    </div>
                    <div class="item"><i class="icon-flow-branch"></i>
                      <strong>
                        40
                      </strong>
                    </div>
  ...
  <!-----------FINAL  SECC ANLS X CLIENTES-------------->
  <!-----------INICIO SECC VENTAS X WEB----------------->
  <!----------- AREA DE VENTAS COMENTADA-------------
  ...
  <!-----------INICIO SECC VENTAS X WEB ---------------->
  <!-----------INICIO SECC LISTA TAREAS----------------->
  <!----------- AREA DE TAREAS COMENTADA------------
        <section class="no-padding-bottom">
          <div class="container-fluid">
            <div class="row">
              <div class="col-lg-6">
  ...
  <!-----------FINAL SECC LISTA TAREAS--------------------->
  <!-----------INICIO SECC VENTAS TOTALES -----------------> 
  <!----------- AREA DE VENTAS TOTALES COMENTADA-------------------     
        <section>
          <div class="container-fluid">
            <div class="row">
              <div class="col-lg-4">
