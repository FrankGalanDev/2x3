...
<html>
  ...
  <!--
          <li><a href="{{asset('analiticas')}}"> <i class="icon-grid"></i>Analitica </a></li>
  -->      
          <li><a href="{{asset('clientes')}}"><i class="icon-grid"></i>Clientes</a></li>
           
          <li><a href="{{asset('contratos')}}"> <i class="icon-grid"></i>Contratos</a></li> 
           
          <li><a href="{{asset('exportaciones')}}"> <i class="icon-grid"></i>Exportac. </a></li>    
          <li><a href="{{asset('facturas')}}"> <i class="icon-grid"></i>Facturas</a></li> 
          <li><a href="{{asset('graficos')}}"> <i class="fa fa-bar-chart"></i>Graficos </a></li>
          <li><a href="{{asset('incidencias')}}"> <i class="icon-grid"></i>Incidencias </a></li>
          <li><a href="{{asset('importaciones')}}"> <i class="icon-grid"></i>Importac. </a></li>
          <li><a href="{{asset('pagos')}}"> <i class="icon-grid"></i>Pagos</a></li>
          <li><a href="{{asset('proveedores')}}"> <i class="icon-grid"></i>Proveedor </a></li>
          <li><a href="{{asset('sitios')}}"> <i class="icon-grid"></i>Sitios</a></li>
          <li><a href="{{asset('tasks')}}"> <i class="icon-grid"></i>Tareas</a></li>
  ...
  -->        
          <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-windows"></i>Config. </a>
            <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
              <li><a href="{{asset('estados')}}">Estados </a></li>
  <!--            <li><a href="{{asset('roles')}}">Roles</a></li>-->
              <li><a href="{{asset('categorias')}}">Categorias</a></li>
              <li><a href="{{asset('planes')}}">Planes</a></li>
        ...
        <ul class="list-unstyled">
          <li> <a href="{{asset('users')}}"> <i class="icon-settings"></i>Colaboradores </a></li>
  <!--        
          <li> <a href="#"> <i class="icon-writing-whiteboard"></i>Chat </a></li>
        ...
        <div class="page-header">
          <div class="container-fluid align-items-center">
            <h2 class="h5 no-margin-bottom">Escritorio
               <a href="{{asset('tickets/create')}}"  style="font-size:0.8rem; font-family: Muli"type=" " class=" col-2 text-center  text-white my-auto"><i class="fas fa-plus-circle" style="color:green;"></i> Nuevo Ticket</i></a>
              <a href="{{asset('usuarios/create')}}"  style="font-size:0.8rem; font-family: Muli" type=" " class=" col-2 text-center  text-white my-auto  "><i class="fas fa-plus-circle" style="color:green;"></i> Nuevo usuario </i></a>
