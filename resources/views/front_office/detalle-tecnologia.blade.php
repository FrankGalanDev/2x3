      ...
      <div id="content">
        <div class="container">
          <section class="no-mb bar">
            <div class="row">
              <div class="col-md-12">
                <p class="lead no-mb">La comercializacion de tecnología en internet es un mercado en crecimiento constante. La demanda de equipamiento tecnológico no decae, y las posibilidades y dispositivos se multiplican constantemente. Casi  en la misma medida que la población mundial crece, también se amplían las capacidades y funcionalidades de estos.</p>
              </div>
            </div>
          </section>
          <section>
            <div class="project owl-carousel">
              <div class="item"><img src="{{ ('img/slider/informatica-slider1.jpg')}}" alt="" class="img-fluid"></div>
              <div class="item"><img src="{{ ('img/slider/informatica-slider2.jpg')}}" alt="" class="img-fluid"></div>
              <div class="item"><img src="{{ ('img/slider/informatica-slider3.jpg')}}" alt="" class="img-fluid"></div>
              <div class="item"><img src="{{ ('img/slider/informatica-slider4.jpg')}}" alt="" class="img-fluid"></div>
          ...
          <section class="bar">
            <div class="row portfolio-project">
              <div class="col-md-8">
                ...
                <p>Sitio web, configurado para la venta online de articulos de tecnología. Cuenta con un diseño atractivo y actualizado. Backoffice administrativo, para personalizar, la gestión de la tienda y al estrategia comercial. </p>
              ...
              <div class="col-md-4 project-more">
                ...
                <h4>Cliente</h4>
                <p>Su clave informatica</p>
                <h4>Servicios</h4>
                <p>Venta online de equipamiento informatico</p>
              </div>
            </div>
          </section>
          <div class="bar pt-0">                       
                  ...
                  <div class="box-image">
                    <div class="image"><img src="{{ ('img/portfolio-3.jpg')}}" alt="" class="img-fluid">
                      <div class="overlay d-flex align-items-center justify-content-center">
                        <div class="content">
                          <div class="name no-mb">
                            <h3><a href="{{ ('detalle-mascotas')}}" class="color-white">Portfolio item</a></h3>
                          </div>
                          <div class="text">
                  ...
                  <div class="box-image">
                    <div class="image"><img src="{{ ('img/portfolio-4.jpg')}}" alt="" class="img-fluid">
                      <div class="overlay d-flex align-items-center justify-content-center">
                        <div class="content">
                          <div class="name no-mb">
                            <h3><a href="{{ ('detalle-tecnología')}}" class="color-white">Portfolio item</a></h3>
                          </div>
                          <div class="text">
