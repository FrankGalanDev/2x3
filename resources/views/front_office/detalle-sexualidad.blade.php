          ...
          <div class="row d-flex align-items-center flex-wrap">
            ...
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                ...
                <li class="breadcrumb-item active">Sexualidad</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div id="content">
        <div class="container">
          <section class="no-mb bar">
            <div class="row">
              <div class="col-md-12">
                <p class="lead no-mb">La  alta demanda de sitios web de este tipo, se basa fundamentalmente en el consumo de juguetería y entretenimiento sexual, el cual se incrementa constantemente, con un abanico de articulos considerable, con múltiples área de uso: desde gustos y  prácticas sexuales, hasta aquellos directamente relacionados con la educación sexual.</p>
              </div>
            </div>
          </section>
          <section>
            <div class="project owl-carousel">
              <div class="item"><img src="{{ ('img/slider/erotica-slider1.jpg')}}" alt="" class="img-fluid"></div>
              <div class="item"><img src="{{ ('img/slider/erotica-slider2.jpg')}}" alt="" class="img-fluid"></div>
              <div class="item"><img src="{{ ('img/slider/erotica-slider3.jpg')}}" alt="" class="img-fluid"></div>
              <div class="item"><img src="{{ ('img/slider/erotica-slider4.jpg')}}" alt="" class="img-fluid"></div>
          ...
          <section class="bar">
            <div class="row portfolio-project">
              <div class="col-md-8">
                ...
                <p>Sitio web, configurado para la venta online de juguetes sexuales. Diseñado para satisfacer la demanda de este mercado. Backoffice administrativo, para personalizar, la gestión de la tienda y al estrategia comercial. </p>
              ...
              <div class="col-md-4 project-more">
                ...
                <h4>Cliente</h4>
                <p>Deseos Discretos</p>
                <h4>Servicios</h4>
                <p>Venta de juguetes sexuales</p>
              </div>
            </div>
          </section>
          <div class="bar pt-0">                       
