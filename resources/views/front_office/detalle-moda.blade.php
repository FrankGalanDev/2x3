      ...
      <div id="content">
        <div class="container">
          <section class="no-mb bar">
            <div class="row">
              <div class="col-md-12">
                <p class="lead no-mb">A pesar de que la moda es un mercado altamente competitivo, los articulos de vestir, son  igualmente demandados y constituyen una parte importante de los negocios online. Buscar un espacio en el mercado puede ser una oportunidad interesante.</p>
              </div>
            </div>
          </section>
          <section>
            <div class="project owl-carousel">
              <div class="item"><img src="{{ ('img/slider/moda-slider1.jpg')}}" alt="" class="img-fluid"></div>
              <div class="item"><img src="{{ ('img/slider/moda-slider2.jpg')}}" alt="" class="img-fluid"></div>
              <div class="item"><img src="{{ ('img/slider/moda-slider3.jpg')}}" alt="" class="img-fluid"></div>
              <div class="item"><img src="{{ ('img/slider/moda-slider4.jpg')}}" alt="" class="img-fluid"></div>
          ...
          <section class="bar">
            <div class="row portfolio-project">
              <div class="col-md-8">
                ...
                <p>Sitio web, configurado para la venta online de articulos de vestir. Diseñado para satisfacer la demanda de este mercado y crear oportunidades. Backoffice administrativo, para personalizar, la gestión de la tienda y al estrategia comercial. </p>
              ...
              <div class="col-md-4 project-more">
                ...
                <p>AleyMeche</p>
                <h4>Servicios</h4>
                <p>Venta de articulos de vestir</p>
              </div>
            </div>
          </section>
          <div class="bar pt-0">                       
                    ...
                    <div class="image"><img src="{{ ('img/portfolio-5.jpg')}}" alt="" class="img-fluid">
                      <div class="overlay d-flex align-items-center justify-content-center">
                        <div class="content">
                          ...
                          <div class="text">
                            <p class="d-none">De a conocer su negocio, a traves una página web propia, le facilitará llegar a más personas, y ampliar su mercado potencial</p>
                            <p class="buttons"><a href="{{ ('detalle-negocios')}}" class="btn btn-template-outlined-white">Ver</a><a href="{{ ('#')}}" class="btn btn-template-outlined-white">Sitio web</a></p>
                          </div>
                        </div>
                      </div>
                    </div>
