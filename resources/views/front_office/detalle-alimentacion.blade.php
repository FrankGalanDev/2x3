      ...
      <div id="content">
        <div class="container">
          <section class="no-mb bar">
            <div class="row">
              <div class="col-md-12">
                <p class="lead no-mb">Tiene un restaurant, un bar, un pub, o algun tipo de negocio donde ofrece comida?. Si es así podemos ayudarle creando una web, para su negocio. Cuidamos de que sus le conozcan y contacten con usted. Cree una atractiva web con nosotros y dediquese a administrar su negocio.</p>
              </div>
            </div>
          </section>
          <section>
            <div class="project owl-carousel">
              <div class="item"><img src="{{ ('img/slider/alimentacion-slider1.jpg')}}" alt="" class="img-fluid"></div>
              <div class="item"><img src="{{ ('img/slider/alimentacion-slider2.jpg')}}" alt="" class="img-fluid"></div>
              <div class="item"><img src="{{ ('img/slider/alimentacion-slider3.jpg')}}" alt="" class="img-fluid"></div>
              <div class="item"><img src="{{ ('img/slider/alimentacion-slider4.jpg')}}" alt="" class="img-fluid"></div>
              <div class="item"><img src="{{ ('img/slider/alimentacion-slider5.jpg')}}" alt="" class="img-fluid"></div>
            </div>
          </section>
          <section class="bar">
