          ...
          <div class="row d-flex align-items-center flex-wrap">
            ...
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                ...
                <li class="breadcrumb-item active">Creativos</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div id="content">
        <div class="container">
          <section class="no-mb bar">
            <div class="row">
              <div class="col-md-12">
                <p class="lead no-mb">Le ofrecemos un modo sencillo, de mostrar al mundo  su trabajo. Si está inmerso de un modo u otro en crear, tenemos una solución web, para que clientes potenciales, aprecien su labor y usted obtenga beneficio de ello. Coloque el resultado de su trabajo al alcance de todos.  .</p>
              </div>
            </div>
          </section>
          <section>
            <div class="project owl-carousel">
              <div class="item"><img src="{{ ('img/slider/creativos-slider1.jpg')}}" alt="" class="img-fluid"></div>
              <div class="item"><img src="{{ ('img/slider/creativos-slider2.jpg')}}" alt="" class="img-fluid"></div>
              <div class="item"><img src="{{ ('img/slider/creativos-slider3.jpg')}}" alt="" class="img-fluid"></div>
              <div class="item"><img src="{{ ('img/slider/creativos-slider4.jpg')}}" alt="" class="img-fluid"></div>
              <div class="item"><img src="{{ ('img/slider/creativos-slider5.jpg')}}" alt="" class="img-fluid"></div>
            </div>
          </section>
          <section class="bar">
