      ...
      <div id="content">
        <div class="container">
          <section class="no-mb bar">
            <div class="row">
              <div class="col-md-12">
                <p class="lead no-mb">Si tu negocio tiene que ver con el cuidado de la salud y el wellness, esta oferta esta pensada para ti. A traves de tu web, conectarás con tu clientes. Podrás acceder a las personas interesadas en tu servicios, detallarles tu oferta, explicarle como contactarte, donde localizarte, y ofrecerle concertar citas</p>
              </div>
            </div>
          </section>
          <section>
            <div class="project owl-carousel">
              <div class="item"><img src="{{ ('img/slider/salud-slider1.jpg')}}" alt="" class="img-fluid"></div>
              <div class="item"><img src="{{ ('img/slider/salud-slider2.jpg')}}" alt="" class="img-fluid"></div>
              <div class="item"><img src="{{ ('img/slider/salud-slider3.jpg')}}" alt="" class="img-fluid"></div>
              <div class="item"><img src="{{ ('img/slider/salud-slider4.jpg')}}" alt="" class="img-fluid"></div>
          ...
          <section class="bar">
            <div class="row portfolio-project">
              <div class="col-md-8">
                ...
                <p>Espacio web dedicado al area de la salud y el wellness, diseñado para mantener un contacto permanente con los clientes.  para ofrecer a  nuestros clientes información específica, sobre nuestro negocio. Es la tarjeta de presentación para aquellos que no venden online y requieren de la presencia física del cliente. </p>
              ...
              <div class="col-md-4 project-more">
                ...
                <p>Cuba Médica</p>
                <h4>Servicios</h4>
                <p>Servicio de consultas médicas</p>
              </div>
            </div>
          </section>
          <div class="bar pt-0">                       
                      ...
                      <div class="overlay d-flex align-items-center justify-content-center">
                        <div class="content">
                          <div class="name no-mb">
                            <h3><a href="{{ ('moda')}}" class="color-white">Moda</a></h3>
                          </div>
                          <div class="text">
